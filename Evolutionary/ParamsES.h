...
namespace Evolutionary
{
	...
	public:
		...
		ParamsES(const std::vector<double> seachSpace, const unsigned maxFitCalls, const bool isSigmaVector,
				 const double sigmaInitial, const double tau0, const double tau1, const unsigned numberOfRecombParents):
		...
		ParamsES() = delete;
		ParamsES(ParamsES&&) = default;
		auto operator=(ParamsES&& obj)->ParamsES& = delete;
		ParamsES(const ParamsES& obj) = default;
