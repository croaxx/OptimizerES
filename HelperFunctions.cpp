...
auto HelperFunctions::MapLinearlyToInterval(const vector<double>& values, const pair<double, double>& intervalFrom,
...
auto HelperFunctions::ReadFileContext(const string& path, const string& specifier = "allLines")->vector<string>
{
	string line;
...
auto HelperFunctions::ClearConsoleWindow()->void
{
